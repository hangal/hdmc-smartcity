		...
		with open('all_works_14_11_15.csv', 'rU') as f:
		    ...
		    for row in reader:
		        ...
		        if row[1] == str(wardNumber):
		        	k.write('<tr>')
		        	k.write('<td class = \"span1\">' + str(wardNumber) + "</td>")        	#ward number
		        	if (len(row[4])<=3):
